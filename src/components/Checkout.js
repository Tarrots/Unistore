            ...
            <div className="checkout">
              <div className="addresses box-select">
                ...
                <address className="box-default sm-padding" data-style="selected">
                  <hr className="offset-sm" />
                  <h3 className="no-margin"><i className="ion-ios-person" /> John Doe</h3>
                  <p>
                    <i className="ion-ios-location" /> 100520, New York City, 45 Park Avenue, United States
                  </p>
                  <div className="check">
                    ...
                    <div className="panel-body">
                      <div className="row group">
                        ...
                        <div className="col-sm-8">
                          ...
                          <div className="group-select justify" tabIndex={1}>
                            <input className="form-control select" id="country" name="country" defaultValue="United Kingdom"  required />
                            ...
                            <div className="arrow bold"><i className="ion-chevron-down" /></div>
                          </div>
                        </div>
                      </div>
                      <hr className="offset-sm" />
                      <div className="row">
                        <div className="col-sm-4">
                          <p>City</p>
                          <input type="text" className="form-control input-sm" name="city" defaultValue required  />
                        </div>
                        <div className="col-sm-4">
                          <hr className="offset-sm visible-xs" />
                          <p>Street</p>
                          <input type="text" className="form-control input-sm" name="street" defaultValue required  />
                        </div>
                        <div className="col-sm-2">
                          <hr className="offset-sm visible-xs" />
                          <p>Building</p>
                          <input type="text" className="form-control input-sm" name="bilding" defaultValue required  />
                        </div>
                        <div className="col-sm-2">
                          <hr className="offset-sm visible-xs" />
                          <p>Zip</p>
                          <input type="text" className="form-control input-sm" name="zip" defaultValue required  />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="payment box-select">
                <h2> 4. Remark </h2>
                <hr className="offset-sm" />
                <textarea name="remark" className="form-control" rows={5} defaultValue={""} />
                <hr className="offset-sm" />
              </div>
            </div>
          </div>
